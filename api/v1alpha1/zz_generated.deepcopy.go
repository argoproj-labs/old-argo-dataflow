...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaAutoCommit) DeepCopyInto(out *KafkaAutoCommit) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaAutoCommit.
func (in *KafkaAutoCommit) DeepCopy() *KafkaAutoCommit {
	if in == nil {
		return nil
	}
	out := new(KafkaAutoCommit)
	in.DeepCopyInto(out)
	return out
}
